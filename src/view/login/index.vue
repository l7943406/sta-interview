              ...
              <div class="leftCon" v-if="vis">
                  <div class="stu-info" >
                    ...
                    <div style="text-indent: 2em">
                      <p>
                        软件科技协会目前开设“Java组”、“Web组”、“C++组”、“Golang组”等，历年来，有斩获微软、字节、阿里、腾讯、百度、快手等大厂offer的学长学姐，更有考入复旦大学、香港大学、南京大学、西安交通大学的前辈，大厂offer？名校上岸？不在话下！
                      </p>
                      <p>
                        学校唯一的ACM算法集训队，周密的学习计划，科学的备赛环节，每周一次的训练赛，助你在比赛中大展身手。校赛，省赛，国赛乃至亚洲赛，铜奖，银奖，金奖拿到手软，综测，奖学金更是不在话下。
                      </p>
                      <p>              
                        软件科技协会和ACM算法队欢迎全校同学的到来，有关纳新问题请加入2021届纳新群聊：959989137。
                      </p>
                    </div>
                  </div>
              </div>
